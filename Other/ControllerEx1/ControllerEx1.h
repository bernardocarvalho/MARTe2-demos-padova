/**
 * @file ControllerExample1.h
 * @brief Header file for class ControllerExample1
 * @date 06/04/2018
 * @author Andre Neto
 *
 ...
 * @details This header file contains the declaration of the class ControllerExample1
